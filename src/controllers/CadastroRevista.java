...
public class CadastroRevista implements Initializable {
    ...
    @FXML
    void addRevista(ActionEvent event) {
        ...
        if (condicao == null || categoria.isEmpty() || editora.isEmpty()) {
            Alert alert = new Alert(AlertType.ERROR);
            alert.setTitle("Erro");
            alert.setHeaderText("Erro ao cadastrar revista");
        ...
        alert.setHeaderText("Confirmação ao cadastrar revista");
        alert.setContentText("Deseja realmente cadastrar a revista?");
        ...
        if (result.get() == btnConfirmar) {
            ...
            try {
                ...
                alertErro.setHeaderText("Erro ao cadastrar revista");
            ...
            alertSucesso.setHeaderText("Sucesso ao cadastrar revista");
            alertSucesso.setContentText("Revista cadastrada com sucesso");
